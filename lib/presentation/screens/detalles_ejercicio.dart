...
class _DetalleEjercicioState extends State<DetalleEjercicio> {
  ...
  Future<void> _setUpAudioPlayer() async{
    _player.playbackEventStream.listen((event) {}, onError: (Object e, StackTrace stracktrace){
      print("$e");
    });
    try{
      _player.setAudioSource(just_audio.AudioSource.uri(Uri.parse(widget.ejercicio.audio!)));
    }catch(e){
      print("Error: $e");
    }
  }
                            ...
                            children: [
                              ...
                              Center(
                                child: ElevatedButton(
                                  ...
                                  int userId =1;
                                  int exerciseId = 15;
                                  es.newExerciseMade(userId, exerciseId);
                                  },
